...
namespace FightSimulation
{
    struct Monster
    {
        ...
        public Monster(string name, float health, float attack, float defense)
        {
            this.name = name;
            this.health = health;
            this.attack = attack;
    ...
    internal class Game
    {
        ...
        {
            //Monster 1
            _monster1 = new Monster("Killzar", 100, 15, 5);
            // Monter 2
            _monster2 = new Monster("Kelthizad", 80, 15, 10);
            // Monster 3
            _monster3 = new Monster("Gim", 5800, 1000, 1);
